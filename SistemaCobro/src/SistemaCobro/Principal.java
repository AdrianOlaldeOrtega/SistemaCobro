...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Panel_Menu_Finanzas.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, 170, 40));
        ...
        Panel_Menu_Finanzas.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 170, 40));
        ...
        Consutla_Pago.setBackground(new java.awt.Color(10, 31, 34));
        Consutla_Pago.setFont(new java.awt.Font("Segoe UI Semilight", 0, 14)); // NOI18N
        Consutla_Pago.setForeground(new java.awt.Color(255, 255, 255));
        ...
        Panel_Menu_Consultas.add(Consutla_Pago, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 170, 40));

        Consulta_Alumno.setBackground(new java.awt.Color(10, 31, 34));
        Consulta_Alumno.setFont(new java.awt.Font("Segoe UI Semilight", 0, 14)); // NOI18N
        Consulta_Alumno.setForeground(new java.awt.Color(255, 255, 255));
        ...
        Panel_Menu_Consultas.add(Consulta_Alumno, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 170, 40));

        Consulta_Deudores.setBackground(new java.awt.Color(10, 31, 34));
        Consulta_Deudores.setFont(new java.awt.Font("Segoe UI Semilight", 0, 14)); // NOI18N
        Consulta_Deudores.setForeground(new java.awt.Color(255, 255, 255));
        ...
        Panel_Menu_Consultas.add(Consulta_Deudores, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 170, 40));
        ...
        btn_cons_mov.setBackground(new java.awt.Color(10, 31, 34));
        btn_cons_mov.setFont(new java.awt.Font("Segoe UI Semilight", 0, 14)); // NOI18N
        btn_cons_mov.setForeground(new java.awt.Color(255, 255, 255));
        btn_cons_mov.setText("Consultar Movimientos");
        ...
        Panel_Menu_Admin.add(btn_cons_mov, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 170, 40));

        btn_alta_usuarios.setBackground(new java.awt.Color(10, 31, 34));
        btn_alta_usuarios.setFont(new java.awt.Font("Segoe UI Semilight", 0, 14)); // NOI18N
        btn_alta_usuarios.setForeground(new java.awt.Color(255, 255, 255));
        btn_alta_usuarios.setText("Alta de Usuarios");
        ...
        Panel_Menu_Admin.add(btn_alta_usuarios, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 170, 40));

        Panel_principal.add(Panel_Menu_Admin, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 320, 220, 110));
